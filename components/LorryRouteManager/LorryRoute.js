...
export default function LorryRoute({navigation}) {
                ...
                <Surface key={doc.id} elevation={4} style={{width:'100%',marginTop:30,borderBottomLeftRadius:4,borderBottomRightRadius:4}}>
                    <View style={styles.containerItem}>
                        <IconButton
                                ...
                                />
                        <View>
                            <Text>Lorry : {doc.lorryNum}</Text>
                            <Text>Date : {doc.sDate}</Text>
                            <Text>Time : {doc.sTime}</Text>
                            <Text>Route : {doc.route}</Text>
                        </View>
                    </View>
